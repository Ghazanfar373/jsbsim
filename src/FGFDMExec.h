...
public:
  ...
  /** Get a pointer to the ground callback currently used. It is recommanded
      ...
      @see FGGroundCallback
   */
  //Return the DDSInterface
  DDSInterface* GetDDSInterface(void)  {return (DDSInterface*)Models[eDDSInterfaces];}
  //Return the Tactical Environment
  TacticalEnvironment* GetTacticalEnvironment(void) {return (TacticalEnvironment*)Models[eTacticalEnvironment];}
  //Return Elevation Model
  ElevationModel* GetElevationModel(void) {return (ElevationModel*)Models[eElevationModel];}
  //Return ElectricalSystem
  ElectricalSystem* GetElectricalSystem(void) {return (ElectricalSystem*)Models[eElectricalSystem];}
...
private:
  ...
  FGOutput* Output;
  TacticalEnvironment* Tactical;
  ElectricalSystem* ElectricalSystemInstance;
  DDSInterface* dds;
