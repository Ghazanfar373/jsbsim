...
protected:
  ...
  static const double NMTOFT;
  static const double FTTONM;
  static const double NMTOMT;
  static const double MTTONM;
  static const double FTTOMT;
  static const double MTTOFT;
  static const double EARTH_RADIUS;
  static const double fpstokts;
  static const double ktstomps;
  static const double mpstokts;
  ...
  static std::string CreateIndexedPropertyName(const std::string& Property, int indexi,int indexj);
