...
public:
  ...
  virtual double GetWindPsiDeg(void) const {return psiw*radtodeg; }
  ...
  virtual void SetWindPsiDeg(double dir);


  virtual void SetWindspeed(double speed);
  virtual void SetWindspeedKts(double speed);

  virtual double GetWindspeed(void) const;
  virtual double GetWindspeedKts(void) const;
