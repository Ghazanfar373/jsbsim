...
const double FGJSBBase::NMTOFT = 6076.12;
const double FGJSBBase::FTTONM = 1.0/6076.12;
const double FGJSBBase::NMTOMT = 1852;
const double FGJSBBase::MTTONM = 1.0/1852;
const double FGJSBBase::FTTOMT = 0.3048;
const double FGJSBBase::MTTOFT = 1.0/0.3048;
const double FGJSBBase::EARTH_RADIUS = 6378137.0;
const double FGJSBBase::fpstokts = 0.592484;
const double FGJSBBase::ktstofps = 1.68781;
const double FGJSBBase::ktstomps = 0.514444;
const double FGJSBBase::mpstokts = 1.9438444;
...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Added for Mirage Rose 3%%%%%%%%%%%%%%%%%%%%%%
string FGJSBBase::CreateIndexedPropertyName(const string& Property, int indexi,int indexj)
{
    std::string temp = Property;
    temp.append("[");
    stringstream si,sj;  // create a stringstream
    si << indexi;
    sj << indexj;
    temp.append(si.str());
    temp.append("]_[");
